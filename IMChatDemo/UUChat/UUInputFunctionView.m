...
@interface UUInputFunctionView ()<UITextViewDelegate,VoiceRecorderDelegate>
{
    BOOL isbeginVoiceRecord;
    VoiceRecorder *recoder;
    NSInteger playTime;
    NSTimer *playTimer;
...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    if (self) {
        recoder = [[VoiceRecorder alloc]initWithDelegate:self];
